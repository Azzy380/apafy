...
""" setup.py for replit_pafy.

https://github.com/Azzy380/pafy-replit-friendly
...
from replit_pafy import __version__

setup(
    name='replit_pafy',
    packages=['replit_pafy'],
    ...
    url="https://github.com/Azzy380/pafy-replit-friendly",
